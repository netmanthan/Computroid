...
from computroidpos.computroidpos.api.m_pesa import submit_mpesa_payment
...
def process_pos_payment(payload):
    ...
    if not data.pos_profile.get("posa_use_pos_computroid_payments"):
        frappe.throw(_("Computroid POS Payments is not enabled for this POS Profile"))
