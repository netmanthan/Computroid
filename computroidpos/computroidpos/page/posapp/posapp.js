{% include "computroidpos/computroidpos/page/posapp/onscan.js" %}
frappe.pages['posapp'].on_page_load = function (wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: 'Computroid POS',
		single_column: true
	});
	...
	$("head").append("<link href='/assets/computroidpos/node_modules/vuetify/dist/vuetify.min.css' rel='stylesheet'>");
